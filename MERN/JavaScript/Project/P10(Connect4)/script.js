...
function handleClick(event) {
    ...
    // Modified logic to find the last empty row in the selected column
    ...
    lastEmptyCell.setAttribute('data-player', currentPlayer);
    gameBoard[row][col] = currentPlayer;
    lastEmptyCell.style.backgroundColor = currentPlayer;
