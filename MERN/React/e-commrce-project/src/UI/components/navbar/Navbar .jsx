        ...
        <Transition.Root show={open} as={Fragment}>
          <Dialog as="div" className="relative z-40 lg:hidden" onClose={setOpen}>
            ...
            <div className="fixed bg-white inset-0 z-40 flex">
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '' }}>
                  ...
                  <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                    ...
                    <div className="flow-root">
                      <Link to={'/profile'} onClick={handleProfileClick} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                        <img
