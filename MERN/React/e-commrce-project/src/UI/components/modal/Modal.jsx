...
export default function Modal() {
    ...
    const { mode, name, address, pincode, phoneNumber, setName, setAddress, setPincode, setPhoneNumber, buyNow } = context;
                ...
                <Dialog as="div" className="relative z-10" onClose={closeModal}>
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl p-2  text-left align-middle shadow-xl transition-all bg-gray-50" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '' }}>
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <form className="space-y-4 md:space-y-6" action="#">
                                                        <div>
                                                            <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>Enter Full Name</label>
                                                        ...
                                                        <div>
                                                            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>Enter Full Address</label>
                                                        ...
                                                        <div>
                                                            <label htmlFor="pincode" className="block mb-2 text-sm font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>Enter Pincode</label>
                                                        ...
                                                        <div>
                                                            <label htmlFor="mobileNumber" className="block mb-2 text-sm font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '' }}>Enter Mobile Number</label>
